...
class Transition(Tk):
    def __init__(self):
        ...
        for F in (Home, SearchPage, BrowsePage):
            frame = F(container, self)
            self.frames[F] = frame
            frame.grid(row=0, column=0, sticky="nsew")

        frame = WP.WritePage(container, self)
        self.frames[WP.WritePage] = frame
        frame.grid(row=0, column=0, sticky="nsew")

        frame = EP.EditPage(container, self)
        self.frames[EP.EditPage] = frame
        frame.grid(row=0, column=0, sticky="nsew")
...
class SearchPage(Frame):
    ...
    def get_items(self):
        ...
        elif (self.by_date.get() and ((not WP.WritePage.is_valid_date(self,self.start_date_input.get())) or (self.start_date_input.get() == ''))):
        ...
        elif (self.by_date.get() and ((not WP.WritePage.is_valid_date(self,self.end_date_input.get())) or (self.end_date_input.get() == ''))):
